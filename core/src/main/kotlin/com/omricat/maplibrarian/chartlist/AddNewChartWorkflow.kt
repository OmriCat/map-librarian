...
internal class AddNewChartWorkflowImpl(
    ...
    StatefulWorkflow<User, AddNewChartWorkflowImpl.State, Event, AddingItemScreen>(),
    AddNewChartWorkflow {
    ...
    internal fun onErrorSaving(chart: UnsavedChartModel, e: AddNewChartError) = action {
